...
#else
        // A Mac window never rotates; the feed is always landscape.
        .landscapeLeft
#endif
    }
...
#else
        let size = NSApplication.shared.keyWindow?.contentLayoutRect.size ?? .zero
        return size.width > 0 ? size : nil
#endif
    }
...
#else
        // macOS windows have no device safe area; SwiftUI handles the title bar.
        EdgeInsets()
#endif
    }
